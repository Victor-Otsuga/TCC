    ...
    <div class="conteudo">
        ...
        <div class="tabelaMontagem" style="margin-bottom: 100px;" id="tableM">
            ...
            <?php while ($linhas_prod = $resultado1->fetch(PDO::FETCH_ASSOC)) {   $id=$linhas_prod["id_prod"]; ?>
                ...
                <div <?php echo "value='$id'" ?> class="itemTab" id="tabelatxt">
                    ...
                    <?php if ($linhas_prod["preco_pacote"] == NULL) {
                        ...
                        if ($linhas_prod["tamanho_uni"] == 1) {
                            echo '<t><button id="carBtn" class="carBtn">1L</button></t></div>';
                        }
                        if ($linhas_prod["tamanho_uni"] == 2) {
                            echo '<t><button id="carBtn" class="carBtn">5L</button></t></div>';
                        }
                    ...
                    if ($linhas_prod["preco_pacote"] <> NULL) {
                        if ($linhas_prod["tamanho_uni"] == 1) {
                            echo '<t><button id="carBtn" class="carBtn">1L</button> <button  class="carBtn">P</button> </t></div>';
                        }
                ...
                <div class="tabelaMontagem" id="tableP">
                    ...
                    <?php while ($linhas_prod = $resultado2->fetch(PDO::FETCH_ASSOC)) {  ?>
                        ...
                        <?php if ($linhas_prod["preco_pacote"] == NULL) {
                        echo '<t><button id="carBtn" class="carBtn">+</button></div>';
                        }else{
                            echo '<t><button id="carBtn" class="carBtn">+</button> <button  class="carBtn">P</button> </t></div>';
                        }
                    };
