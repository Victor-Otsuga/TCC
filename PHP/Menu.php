...
<div class="car-scn" id="car-aba"  onmouseleave="fechacar()">
    ...
    <a href="MontagemPedido/final.php" style="text-decoration: none; color:black;"><div> <img src="../IMG/carrinho.png" class="icones" id="carrinhoPop" > <p class="txt" style="text-align: center; margin-bottom: 20px;">Abrir Venda</p></div></a>    <div class="carpop" >
